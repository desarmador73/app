 ...
 * @property string $descorganizacion
...
class Organizacion extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('descorganizacion, estado', 'required'),
			array('descorganizacion', 'length', 'max'=>255),
			array('estado', 'length', 'max'=>1),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('idorganizacion, descorganizacion, estado', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'datosacads' => array(self::HAS_MANY, 'Datosacad', 'idorganizacion'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('descorganizacion',$this->descorganizacion,true);
