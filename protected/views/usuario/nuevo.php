...
<fieldset>
    ...
    <div class="row">
        <div class="col-md-6">
            <?php echo CHtml::activeLabel($model,'passw'); ?>
            <?php echo CHtml::activeTextField($model,'passw',
                array('class'=>'form-control input-sm')) ?>
        </div>
        <div class="col-md-6">
            <?php echo CHtml::activeLabel($model,'passw2'); ?>
            <?php echo CHtml::activeTextField($model,'passw2',
                array('class'=>'form-control input-sm')) ?>
        </div>
    </div>
</fieldset>
